...
@Component({
    ...
    imports: [CommonModule, TableModule, ButtonModule, RippleModule, IconFieldModule, InputIconModule, InputTextModule, FormsModule, CardModule, TooltipModule, TagModule, SelectModule],
    template: `<p-card class="mb-4 min-h-[444px]">
        <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
            <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-4 md:mb-0">Top Selling Product</div>
            <div class="inline-flex items-center"></div>
        </div>
        <div class="min-h-[400px]">
            <p-table #dt [rows]="10" [value]="products" [paginator]="true" responsiveLayout="scroll" [scrollable]="true" scrollHeight="350px">
                <ng-template #header>
                    <tr>
                        <th>Item</th>
                        <th>Category</th>
